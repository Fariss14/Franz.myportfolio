  ...
  const linkedInCertificates = [
    {
      ...
      hours: "4 hours",
      pdfUrl: "/src/assets/certificates/LinkedIn/Programming-Foundations-Fundamentals.pdf",
    },
    {
      ...
      hours: "6 hours",
      pdfUrl:
        "/src/assets/certificates/LinkedIn/Microsoft-Security-Operations-Analyst-Associate-SC200-Cert-Prep-by-Microsoft-Press.pdf",
    },
    {
      ...
      hours: "8 hours",
      pdfUrl:
        "/src/assets/certificates/LinkedIn/Certified-Information-Systems-Security-Professional-CISSP-2024-Cert-Prep.pdf",
    },
    {
      name: "Empathy in UX Design",
      issueDate: "April 2023",
      hours: "3 hours",
      pdfUrl: "/src/assets/certificates/LinkedIn/Empathy-in-UX-Design.pdf",
    },
    {
      name: "UX Foundations: Generational Design",
      issueDate: "May 2023",
      hours: "4 hours",
      pdfUrl: "/src/assets/certificates/LinkedIn/UX-Foundations-Generational-Design.pdf",
    },
    {
      name: "UX Deep Dive: Usability Testing",
      issueDate: "June 2023",
      hours: "5 hours",
      pdfUrl: "/src/assets/certificates/LinkedIn/UX-Deep-Dive-Usability-Testing.pdf",
    },
    {
      name: "UX Foundations: Storytelling",
      issueDate: "July 2023",
      hours: "3 hours",
      pdfUrl: "/src/assets/certificates/LinkedIn/UX-Foundations-Storytelling.pdf",
    },
    {
      name: "UX Deep Dive: Analyzing Data",
      issueDate: "August 2023",
      hours: "4 hours",
      pdfUrl: "/src/assets/certificates/LinkedIn/UX-Deep-Dive-Analyzing-Data.pdf",
    },
    {
      name: "Sketching for UX Designers",
      issueDate: "September 2023",
      hours: "3 hours",
      pdfUrl: "/src/assets/certificates/LinkedIn/Sketching-for-UX-Designers.pdf",
    },
    {
      name: "Improve Your UX Design Skills",
      issueDate: "October 2023",
      hours: "5 hours",
      pdfUrl: "/src/assets/certificates/LinkedIn/Improve-Your-UX-Design-Skills.pdf",
    },
    {
      name: "Creating Your IT Strategy",
      issueDate: "November 2023",
      hours: "4 hours",
      pdfUrl: "/src/assets/certificates/LinkedIn/Creating-Your-IT-Strategy.pdf",
    },
    {
      name: "Introduction to IT Architecture",
      issueDate: "December 2023",
      hours: "6 hours",
      pdfUrl: "/src/assets/certificates/LinkedIn/Introduction-to-IT-Architecture-2020.pdf",
    },
    {
      name: "Program Management for IT Professionals",
      issueDate: "January 2024",
      hours: "5 hours",
      pdfUrl: "/src/assets/certificates/LinkedIn/Program-Management-for-IT-Professionals-2018.pdf",
    },
    {
      name: "Succeeding as a First-Time Tech Manager",
      issueDate: "February 2024",
      hours: "4 hours",
      pdfUrl: "/src/assets/certificates/LinkedIn/Succeeding-as-a-FirstTime-Tech-Manager-2019.pdf",
    },
    {
      name: "Cybersecurity Fundamentals",
      issueDate: "March 2024",
      hours: "6 hours",
      pdfUrl: "/src/assets/certificates/LinkedIn/Cybersecurity-Fundamentals.pdf",
    },
    {
      name: "Cybersecurity with Cloud Computing",
      issueDate: "April 2024",
      hours: "5 hours",
      pdfUrl: "/src/assets/certificates/LinkedIn/Cybersecurity-with-Cloud-Computing.pdf",
    },
    {
      name: "TLS for Beginners: Securing Network Communications",
      issueDate: "May 2024",
      hours: "3 hours",
      pdfUrl: "/src/assets/certificates/LinkedIn/TLS-for-Beginners-Securing-Network-Communications.pdf",
    },
    {
      name: "UX Foundations: Interaction Design",
      issueDate: "June 2024",
      hours: "4 hours",
      pdfUrl: "/src/assets/certificates/LinkedIn/UX-Foundations-Interaction-Design.pdf",
    },
    {
      name: "Project Management Foundations",
      issueDate: "July 2024",
      hours: "5 hours",
      pdfUrl: "/src/assets/certificates/LinkedIn/Project-Management-Foundations.pdf",
    },
    {
      name: "Principle for UX Design",
      issueDate: "August 2024",
      hours: "3 hours",
      pdfUrl: "/src/assets/certificates/LinkedIn/Principle-for-UX-Design.pdf",
    },
    {
      name: "Introduction to Identity and Access Management",
      issueDate: "September 2024",
      hours: "4 hours",
      pdfUrl: "/src/assets/certificates/LinkedIn/Introduction-to-Identity-and-Access-Management.pdf",
    },
    {
      name: "IT Security Foundations: Network Security",
      issueDate: "October 2024",
      hours: "6 hours",
      pdfUrl: "/src/assets/certificates/LinkedIn/IT-Security-Foundations-Network-Security.pdf",
    },
    {
      name: "User Experience (UX) for Non-Designers",
      issueDate: "November 2024",
      hours: "3 hours",
      pdfUrl: "/src/assets/certificates/LinkedIn/User-Experience-UX-for-NonDesigners.pdf",
    },
    {
      name: "Figma Essential Training: The Basics",
      issueDate: "December 2024",
      hours: "4 hours",
      pdfUrl: "/src/assets/certificates/LinkedIn/Figma-Essential-Training-The-Basics.pdf",
    },
    {
      name: "IT Security Foundations: Operating System Security",
      issueDate: "January 2025",
      hours: "5 hours",
      pdfUrl: "/src/assets/certificates/LinkedIn/IT-Security-Foundations-Operating-System-Security.pdf",
    },
    {
      name: "Computer Science Principles: Digital Information",
      issueDate: "February 2025",
      hours: "3 hours",
      pdfUrl: "/src/assets/certificates/LinkedIn/Computer-Science-Principles-Digital-Information.pdf",
    },
    {
      name: "Computer Science Principles: The Internet",
      issueDate: "March 2025",
      hours: "4 hours",
      pdfUrl: "/src/assets/certificates/LinkedIn/Computer-Science-Principles-The-Internet.pdf",
    },
    {
      name: "Cybersecurity Foundations: Security Architecture",
      issueDate: "April 2025",
      hours: "5 hours",
      pdfUrl: "/src/assets/certificates/LinkedIn/Cybersecurity-Foundations-Security-Architecture.pdf",
    },
    {
      name: "Security Frameworks Fundamentals",
      issueDate: "May 2025",
      hours: "4 hours",
      pdfUrl: "/src/assets/certificates/LinkedIn/Security-Frameworks-Fundamentals.pdf",
    },
    {
      name: "Cybersecurity Foundations",
      issueDate: "June 2025",
      hours: "6 hours",
      pdfUrl: "/src/assets/certificates/LinkedIn/Cybersecurity-Foundations.pdf",
    },
    {
      name: "IT Security Foundations: Core Concepts",
      issueDate: "July 2025",
      hours: "5 hours",
      pdfUrl: "/src/assets/certificates/LinkedIn/IT-Security-Foundations-Core-Concepts.pdf",
    },
  ]
  ...
  const simplilearnCertificates = [
    {
      ...
      issueDate: "January 2023",
      hours: "20 hours",
      pdfUrl: "/src/assets/certificates/Simplilearn/AzureFundamentals.pdf",
    },
    {
      name: "Business Intelligence Fundamentals",
      issueDate: "February 2023",
      hours: "25 hours",
      pdfUrl: "/src/assets/certificates/Simplilearn/BusinessIntelligenceFundamentals.pdf",
    },
    {
      name: "GitHub Copilot Fundamentals",
      issueDate: "March 2023",
      hours: "15 hours",
      pdfUrl: "/src/assets/certificates/Simplilearn/github-copilot-fundamentals.pdf",
    },
    {
      name: "Introduction to Cloud Security",
      issueDate: "April 2023",
      hours: "30 hours",
      pdfUrl: "/src/assets/certificates/Simplilearn/intro-to-cloud-security.pdf",
    },
    {
      name: "Introduction to DevOps",
      issueDate: "May 2023",
      hours: "25 hours",
      pdfUrl: "/src/assets/certificates/Simplilearn/intro-to-devops.pdf",
    },
    {
      name: "Introduction to CBAP",
      issueDate: "June 2023",
      hours: "20 hours",
      pdfUrl: "/src/assets/certificates/Simplilearn/introduction-to-CBAP.pdf",
    },
    {
      name: "Introduction to Data Visualization",
      issueDate: "July 2023",
      hours: "15 hours",
      pdfUrl: "/src/assets/certificates/Simplilearn/Introduction-to-Data-Visualization.pdf",
    },
    {
      name: "Introduction to Frontend Development",
      issueDate: "August 2023",
      hours: "30 hours",
      pdfUrl: "/src/assets/certificates/Simplilearn/introduction-to-frontend-development.pdf",
    },
    {
      name: "Introduction to Paid Media Marketing",
      issueDate: "September 2023",
      hours: "20 hours",
      pdfUrl: "/src/assets/certificates/Simplilearn/introduction-to-paid-media-marketing.pdf",
    },
    {
      name: "Introduction to PRINCE2",
      issueDate: "October 2023",
      hours: "25 hours",
      pdfUrl: "/src/assets/certificates/Simplilearn/introduction-to-prince.pdf",
    },
    {
      name: "Project Management 101",
      issueDate: "November 2023",
      hours: "30 hours",
      pdfUrl: "/src/assets/certificates/Simplilearn/project-management-101.pdf",
    },
    {
      name: "Python for Beginners",
      issueDate: "December 2023",
      hours: "25 hours",
      pdfUrl: "/src/assets/certificates/Simplilearn/python-for-beginners.pdf",
    },
    {
      name: "ReactJS for Beginners",
      issueDate: "January 2024",
      hours: "30 hours",
      pdfUrl: "/src/assets/certificates/Simplilearn/reactjs-for-beginners.pdf",
    },
  ]
